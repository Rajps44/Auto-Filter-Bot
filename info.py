...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1001860172104') #bot log channel -1005293546253
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1001937259467') #support group id ex:  -1002936246860
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://owajshaikhrcm:TSe14x06n2LBVzSi@cluster0.ssats.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") #mongo db url
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002040575112") #if is_stream = true then add a channel id ex: -10026393639
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://t.me/netflixehindi") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
